...
\pagebreak
\section*{Apendice al ejercicio 3}

Delfina se ahorró el cálculo de $f_Z(z)$ para obtener $E(Z)$. Calculo $E(Z)$
como sigue:

\begin{align*}
    E(Z)=E(I^2)=\int_6^{10}i^2f_Y(y)dy=\frac{1}{4}\int_6^{10}i^2dy=\frac{1}{4}\left.\frac{i^3}{3}\right|=\frac{1}{4}\left(\frac{1000}{3}-\frac{216}{3}\right)=\frac{784}{12}
\end{align*}

obteniendo el mismo resultado para la Eq.~\ref{eq:EZ}.
\end{document}
